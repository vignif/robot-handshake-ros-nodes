...
echo_and_run cd "/home/sirslab/ros_ws_handshake/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sirslab/ros_ws_handshake/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/sirslab/ros_ws_handshake/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
