...
echo_and_run cd "/home/francesco/ros_ws_handshake/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/home/francesco/ros_ws_handshake/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/francesco/ros_ws_handshake/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
