...
if("FALSE" STREQUAL "TRUE")
  set(rosbridge_library_SOURCE_PREFIX /home/francesco/ros_ws_handshake/src/rosbridge_suite/rosbridge_library)
  set(rosbridge_library_DEVEL_PREFIX /home/francesco/ros_ws_handshake/devel)
  ...
  set(rosbridge_library_INSTALL_PREFIX /home/francesco/ros_ws_handshake/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_library' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/francesco/ros_ws_handshake/install/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
