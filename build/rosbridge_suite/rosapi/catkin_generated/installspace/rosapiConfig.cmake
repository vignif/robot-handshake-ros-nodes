...
if("FALSE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/francesco/ros_ws_handshake/src/rosbridge_suite/rosapi)
  set(rosapi_DEVEL_PREFIX /home/francesco/ros_ws_handshake/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/francesco/ros_ws_handshake/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/francesco/ros_ws_handshake/install/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
