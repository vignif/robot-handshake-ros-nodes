...
"""autogenerated by genpy from qb_interface/handRef.msg. Do not edit."""
import sys
...
class handRef(genpy.Message):
  _md5sum = "3d3fcdda7faa52ddfc5831b96497f9ca"
  _type = "qb_interface/handRef"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(handRef, self).__init__(*args, **kwds)
